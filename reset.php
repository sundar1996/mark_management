...
<div class="container-fluid">
	...
	<div class="row" style="height:100px;"></div>
		<div class="row"><center><h1>RESET</h1></center></div>
		<hr>
			<div class="row">
	               		...
	               		<div class="panel-body">
	                        <div class="form-horizontal">
								...
								<div class="form-group">
	                         	 	...
	                         	 	<div class="col-md-6">
										<input type="text" class="form-control" name="name" id="name_t">
	                          		</div>
	                         	 </div>
								...
								<div class="form-group">
	                         	 	...
	                         	 	<div class="col-md-6">
										<input type="text" class="form-control" name="name" id="user_t">
	                          		</div>
	                         	 </div>
								...
								<div id="semester6">
	                         	 ...
	                         	 <div class="form-group">
	                            	<div class="col-md-6 col-md-offset-4">
	                                	<button type="button" class="btn btn-primary" onclick="reset_details();">
