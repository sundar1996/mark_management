...
if (!empty($_POST['username']) && !empty($_POST['password']))
{
	...
	$sql = "SELECT id,username,password,role FROM login WHERE username = '$usname' AND password='$paswd'";
	...
	if ($usname == $per_name && $paswd == $per_pass && $per_role=="admin") {
...
<div class="container">
	...
	<div class="row" style="height:180px;"></div>
		<div class="row"><center><h1>ADMIN PORTAL</h1></center></div>
		<hr>
			<div class="row">
